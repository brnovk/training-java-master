...
javac -encoding utf-8 -classpath ./src -d ./classes src/RunnerConcurrentXml.java

:: Запуск приложения из class-файлов 
:: java -classpath ./classes;./lib/commons-lang-2.6.jar;./lib/commons-logging-1.1.1.jar;./lib/hsqldb.jar;./lib/jackcess-2.1.3.jar;./lib/ucanaccess-3.0.6.jar RunnerConcurrentXml
:: pause
...
jar cvmf "manifest (for multi-threaded xml-runner)"/manifest.mf runnable_jar/appl-multi-threaded-xml.jar -C ./classes .
pause
...
java -jar runnable_jar/"appl-multi-threaded-xml".jar
pause
