...
:: java -classpath ./classes;./lib/commons-lang-2.6.jar;./lib/commons-logging-1.1.1.jar;./lib/hsqldb.jar;./lib/jackcess-2.1.3.jar;./lib/ucanaccess-3.0.6.jar RunnerXml
:: pause
