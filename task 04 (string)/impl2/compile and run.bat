...
:: Копирование in.properties в каталог со скомпилированными классами, для 
:: последующего запуска или упаковки в запускаемый jar.
COPY "src\in.properties" "classes\in.properties"
